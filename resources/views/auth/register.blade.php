...
<main class="auth">
    <header id="auth-header" class="auth-header" style="background-image: url(assets/images/illustration/img-1.png);">
        <h1>
            ...
            </svg> <span class="sr-only">create User</span>
        </h1>
        <p> Already have an account? please <a href="">Sign In</a>
        </p>
    </header><!-- form -->
    @if ($errors->any())
    ...
    <form class="auth-form" action="{{ route('register') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <div class="form-label-group">
                <input type="email" value="{{ old('email') }}" id="inputEmail" name="email" class="form-control"
        ...
        <div class="form-group">
            <div class="form-label-group">
                <input type="text" value="{{ old('phoneNumber') }}" id="phoneNumber" name="phoneNumber"

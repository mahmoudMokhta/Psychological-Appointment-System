            ...
            <div class="row gy-6">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="footer-widget">
                        <a href="#" class="footer-widget__logo"><img src="{{asset('frontend/assets/images/logo.png')}}" alt="Logo" width="150" height="32"></a>
                        ...
                        <div class="footer-widget__info">
                            <p>56 تجربة للعنوان فقط مجرد عنوان ليس أكثر</p>
                ...
                <div class="col-lg-8">
                    <div class="row gy-6">
                        ...
                        <div class="col-sm-4">
                            <!-- Footer Widget Start -->
                            <div class="footer-widget">
                                <h4 class="footer-widget__title">@lang('about')</h4>
                        ...
                        <div class="col-sm-4">
                            <!-- Footer Widget Start -->
                            <div class="footer-widget">
                                <h4 class="footer-widget__title">@lang('links')</h4>
        ...
        <div class="container">
            <div class="copyright-wrapper text-center">
                <ul class="footer-widget__link flex-row gap-8 justify-content-center">
                    <li><a href="#">@lang('terms')</a></li>
                    <li><a href="#">@lang('privacy')</a></li>
                </ul>
                <p class="footer-widget__copyright mt-0">
                    &copy; 2023 <span> Appointment System </span>
                    Made with <i class="fa fa-heart"></i>
                    by <a href="#">Mahmoud Mansour</a></p>
            </div>
        </div>
    </div>
    <!-- Footer Copyright Area End -->
